...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d4 = $_GET["d4"]; 
		$d5 = $_GET["d5"]; 	
		mysqli_query($conn,"INSERT INTO $tabname (No, Year, Season, CourseID, TeacherID, ClassID) VALUES (NULL, '$d1', '$d2', '$d3', '$d4', '$d5');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d4 = $_GET["d4"]; 
		$d5 = $_GET["d5"]; 
		mysqli_query($conn,"UPDATE $tabname SET Year='$d1', Season='$d2', CourseID='$d3', TeacherID='$d4', ClassID='$d5' WHERE No='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
		$qid = $_GET["qid"];		
		mysqli_query($conn,"DELETE FROM $tabname WHERE No='$qid'");			
	}		
	//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT registrationtab.No, registrationtab.Year, registrationtab.Season, coursetab.CourseName ,teachertab.TeacherName,classtab.ClassName
...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d2 = $_GET["d2"]; 
		$d3 = $_GET["d3"]; 		
		mysqli_query($conn,"INSERT INTO $tabname (No, Year, Season, Note) VALUES (NULL, '$d1', '$d2', '$d3');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d2 = $_GET["d2"];
		$d3 = $_GET["d3"]; 
		mysqli_query($conn,"UPDATE $tabname SET Year='$d1', Season='$d2', Note='$d3' WHERE No='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
...
//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT * FROM $tabname");
	if ($result==null)
	{
		echo "<li> 找不到資料 </li>";
		exit();
...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d5 = $_GET["d5"]; 
		$d6 = $_GET["d6"];
		mysqli_query($conn,"INSERT INTO classtab (No, ClassID, ClassName, Year, School, Department, Note) VALUES (NULL, '$d1', '$d2', '$d3', '$d4', '$d5', '$d6');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d5 = $_GET["d5"]; 
		$d6 = $_GET["d6"];
		mysqli_query($conn,"UPDATE classtab SET ClassID='$d1', ClassName='$d2', Year='$d3', School='$d4', Department='$d5', Note='$d6' WHERE  ClassID='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
		$cid = $_GET["cid"];		
		mysqli_query($conn,"DELETE FROM classtab WHERE ClassID='$cid'");			
	}
//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT * FROM $tabname");
	if ($result==null)
...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d2 = $_GET["d2"]; 
		$d3 = $_GET["d3"]; 
		mysqli_query($conn,"INSERT INTO coursetab (No, CourseID, CourseName, Note) VALUES (NULL, '$d1', '$d2', '$d3');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d2 = $_GET["d2"]; 
		$d3 = $_GET["d3"]; 
		mysqli_query($conn,"UPDATE coursetab SET CourseID='$d1', CourseName='$d2', Note='$d3' WHERE CourseID='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
		$qid = $_GET["qid"];		
		mysqli_query($conn,"DELETE FROM coursetab WHERE CourseID='$qid'");			
	}
//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT * FROM $tabname");
	if ($result==null)
...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d6 = $_GET["d6"];
		$d7 = $_GET["d7"];		
		mysqli_query($conn,"INSERT INTO $tabname (No, StudnetID, StudentName, ClassID, TELE, Email, Addr, Note) VALUES (NULL, '$d1', '$d2', '$d3', '$d4', '$d5', '$d6', '$d7');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d6 = $_GET["d6"];
		$d7 = $_GET["d7"];
		mysqli_query($conn,"UPDATE $tabname SET StudnetID='$d1', StudentName='$d2', ClassID='$d3', TELE='$d4', Email='$d5', Addr='$d6', Note='$d7' WHERE StudnetID='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
		$qid = $_GET["qid"];		
		mysqli_query($conn,"DELETE FROM $tabname WHERE StudnetID='$qid'");			
	}	
//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT * FROM $tabname");
	if ($result==null)
	...
	{
		$t = $_GET["t"];
		$result = mysqli_query($conn,"SELECT * FROM $tabname WHERE ClassID='$t'");
		if ($result==null)
		{
			echo "<li> 找不到資料 </li>";
			exit();
...
//*****------新增資料-----*****************
	if($act=="add")
	{
		...
		$d4 = $_GET["d4"]; 
		$d5 = $_GET["d5"]; 	
		mysqli_query($conn,"INSERT INTO $tabname (No, TeacherID, TeacherName, Email, TELE, Note) VALUES (NULL, '$d1', '$d2', '$d3', '$d4', '$d5');");
	}	
//*****------修改資料-----*****************	
	if($act=="upda")
	{
		...
		$d4 = $_GET["d4"]; 
		$d5 = $_GET["d5"]; 
		mysqli_query($conn,"UPDATE $tabname SET TeacherID='$d1', TeacherName='$d2', Email='$d3', TELE='$d4', Note='$d5' WHERE TeacherID='$qid'");		
	}
//*****------刪除資料-----*****************
	if($act=="del")
	{
		$qid = $_GET["qid"];		
		mysqli_query($conn,"DELETE FROM $tabname WHERE TeacherID='$qid'");			
	}		
//*****------查詢產生TABLE-----*****************
	$result = mysqli_query($conn,"SELECT * FROM $tabname");
	if ($result==null)
